...
// Reconstructed Stylized Owl (White)
const IconOwl = () => (
  <svg width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: '40px', flexShrink: 0 }}>
    <path d="M12 2c3 0 6 2 7 5 1 3 1 7-1 10-2 3-4 5-6 5s-4-2-6-5c-2-3-2-7-1-10 1-3 4-5 7-5Z" />
    <path d="M9 8c.5-1 1.5-1.5 3-1.5s2.5.5 3 1.5" />
    <circle cx="9" cy="11" r="1.5" fill="white" />
    <circle cx="15" cy="11" r="1.5" fill="white" />
    <path d="m11 14 1 1 1-1" />
    <path d="M8 18c2 1.5 6 1.5 8 0" />
    <path d="M3 8c1-2 3-3 3-3M21 8c-1-2-3-3-3-3" />
  </svg>
);
    ...
    <div style={{ backgroundColor: '#050505', color: 'white', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', padding: '60px 20px', scrollBehavior: 'smooth' }}>
      ...
      <section style={{ maxWidth: '1100px', margin: '0 auto 140px' }}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: 'clamp(48px, 8vw, 84px)', fontWeight: '900', lineHeight: '0.85', letterSpacing: '-0.05em' }}>
