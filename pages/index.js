...
// The "Authentic Intelligence" Mark: High-Fidelity Geometric Human
const IconAUI = () => (
  <svg 
    width="450" 
    height="450" 
  ...
  >
    {/* Geometric Cranium / Facets */}
    <path d="M12 2C8 2 5 5 5 9c0 4 2 8 7 13 5-5 7-9 7-13 0-4-3-7-7-7z" />
    <path d="M12 2v20" strokeOpacity="0.2" />
    <path d="M5 9h14" strokeOpacity="0.2" />
    
    {/* Mechanical Eye Orbits */}
    <path d="M8 9h2v2H8z" stroke="#2563eb" strokeWidth="1" />
    <path d="M14 9h2v2h-2z" stroke="#2563eb" strokeWidth="1" />
    
    {/* Interlocking "Neural" lines */}
    <path d="M7 5l10 8M17 5L7 13" strokeOpacity="0.4" />
    <path d="M12 6l-5 4 5 4 5-4-5-4z" />
    <path d="M12 16l-3-3 3-3 3 3-3 3z" />
    
    {/* Lower Jaw / Foundation */}
    <path d="M9 18l3 3 3-3" strokeOpacity="0.6" />
  </svg>
);
  ...
  return (
    <div style={{ backgroundColor: '#050505', color: 'white', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', padding: '60px 20px', scrollBehavior: 'smooth' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 140px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ flex: 1 }}>
          <h1 style={{ fontSize: 'clamp(48px, 8vw, 84px)', fontWeight: '900', lineHeight: '0.85', letterSpacing: '-0.05em', marginBottom: '40px' }}>
      ...
      <section id="method" style={{ maxWidth: '1200px', margin: '0 auto 140px', borderTop: '1px solid #1f2937', paddingTop: '80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '50px' }}>
          ...
          <div><IconShield /><h3 style={{ fontSize: '14px', margin: '20px 0 15px' }}>[02] PATTERN ISOLATION</h3><p style={{ color: '#6b7280', fontSize: '14px' }}>Identifying deviations that precede major shifts.</p></div>
